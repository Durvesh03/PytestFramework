class SearchCustomer:
    # Add customer Page
    elementDropDown_xpath = "//i[@class='fa fa-angle-down']"
    txtEmail_id = "SearchEmail"
    txtFirstName_id="SearchFirstName"
    txtLastName_id="SearchLastName"
    btnSearch_id="search-customers"

    tblSearchResults_xpath="(//table[@role='grid'])[2]"
    ...
    def ClickOnDropDown(self):
        self.driver.find_element_by_xpath(self.elementDropDown_xpath).click()

    def ChkEmailObjExistence(self):
        if self.driver.find_element_by_id(self.txtEmail_id).size['width'] > 0:
            return True
        else:
            return False
